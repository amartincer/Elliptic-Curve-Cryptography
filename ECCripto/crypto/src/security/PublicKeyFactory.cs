    ...
    public sealed class PublicKeyFactory
    {
			...
			SubjectPublicKeyInfo keyInfo)
        {
			...
			else if (algOid.Equals(X9ObjectIdentifiers.IdECPublicKey))
			{
                ...
                //////////////////////////////////////////////////////////////////////// Código puesto por mi (Alejandro Martín) el día 27/01/2012
                if (keyInfo != null && keyInfo.AlgorithmID != null && keyInfo.AlgorithmID.Parameters != null && keyInfo.AlgorithmID.Parameters is DerObjectIdentifier)
                    return new ECPublicKeyParameters("EC", derQ.Point, (DerObjectIdentifier)keyInfo.AlgorithmID.Parameters);
                else return new ECPublicKeyParameters("EC", derQ.Point, dParams);
                ////////////////////////////////////////////////////////////////////////
