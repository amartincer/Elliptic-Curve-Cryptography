    ...
    public sealed class PrivateKeyFactory
    {
			...
			PrivateKeyInfo keyInfo)
        {
			...
			else if (algOid.Equals(X9ObjectIdentifiers.IdECPublicKey))
			{
                ...
                /////////////////// puesto por mí (Alejandro Martín el día 26/01/2012)
                if (ec.GetParameters() is DerObjectIdentifier)
                    return new ECPrivateKeyParameters("EC", ec.GetKey(), (DerObjectIdentifier)ec.GetParameters());
                else return new ECPrivateKeyParameters("EC", ec.GetKey(), dParams);
                ////////////////////////////////////////////
