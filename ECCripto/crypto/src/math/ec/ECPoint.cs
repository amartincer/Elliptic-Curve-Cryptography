...
namespace Org.BouncyCastle.Math.EC
{
	...
	public abstract class ECPoint
	{
        ...
        internal abstract bool Belong{get;}
...
//		}
		...
		: ECPointBase
	{
        ...
        internal override bool Belong
        {
            get
            {
                if (this==curve.Infinity)
                    return true;
                return (y.ToBigInteger().Pow(2) % ((FpCurve)curve).Q).Equals((x.ToBigInteger().Pow(3) + curve.a.ToBigInteger() * x.ToBigInteger() + curve.b.ToBigInteger()) % ((FpCurve)curve).Q);
            }
        }
