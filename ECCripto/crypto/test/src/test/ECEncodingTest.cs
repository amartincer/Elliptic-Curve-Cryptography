...
//			string oldPrivateKey = new string(Hex.encode(privateECKey.getEncoded()));
			...
			string oldPrivateKey = Encoding.ASCII.GetString(Hex.Encode(oldPrivateKeyBytes));
//			string oldPublicKey = new string(Hex.encode(pub.getEncoded()));
			...
			string oldPublicKey = Encoding.ASCII.GetString(Hex.Encode(oldPublicKeyBytes));
...
//			string newPrivateKey = new string(Hex.encode(newKey.getEncoded()));
			...
			string newPrivateKey = Encoding.ASCII.GetString(Hex.Encode(newPrivateKeyBytes));
//			string newPublicKey = new string(Hex.encode(newPubKey.getEncoded()));
			...
			string newPublicKey = Encoding.ASCII.GetString(Hex.Encode(newPublicKeyBytes));
