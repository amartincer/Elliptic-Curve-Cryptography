...
//			c.init(Cipher.ENCRYPT_MODE, pubKey, rand);
			...
			{
				Fail("NoPadding test failed on encrypt expected " + Encoding.ASCII.GetString(Hex.Encode(output[0])) + " got " + Encoding.ASCII.GetString(Hex.Encode(outBytes)));
			}
...
//			c.init(Cipher.DECRYPT_MODE, privKey);
			...
			{
				Fail("NoPadding test failed on decrypt expected " + Encoding.ASCII.GetString(Hex.Encode(input)) + " got " + Encoding.ASCII.GetString(Hex.Encode(outBytes)));
			}
...
//			c.init(Cipher.DECRYPT_MODE, privKey);
			...
			if (!AreEqual(outBytes, maxInput))
			{
				Fail("NoPadding test failed on decrypt expected "
					+ Encoding.ASCII.GetString(Hex.Encode(maxInput)) + " got "
					+ Encoding.ASCII.GetString(Hex.Encode(outBytes)));
			}
			...
			{
				Fail("PKCS1 test failed on encrypt expected " + Encoding.ASCII.GetString(Hex.Encode(output[1])) + " got " + Encoding.ASCII.GetString(Hex.Encode(outBytes)));
			}
			...
			if (!AreEqual(outBytes, input))
			{
				Fail("PKCS1 test failed on decrypt expected " + Encoding.ASCII.GetString(Hex.Encode(input)) + " got " + Encoding.ASCII.GetString(Hex.Encode(outBytes)));
			}
...
//			}
			...
			{
				Fail("OAEP SHA-224 test failed on encrypt expected " + Encoding.ASCII.GetString(Hex.Encode(output[2])) + " got " + Encoding.ASCII.GetString(Hex.Encode(outBytes)));
			}
			...
			if (!AreEqual(outBytes, input))
			{
				Fail("OAEP SHA-224 test failed on decrypt expected " + Encoding.ASCII.GetString(Hex.Encode(input)) + " got " + Encoding.ASCII.GetString(Hex.Encode(outBytes)));
			}
...
//			}
			...
			{
				Fail("OAEP SHA-256 test failed on encrypt expected " + Encoding.ASCII.GetString(Hex.Encode(output[2])) + " got " + Encoding.ASCII.GetString(Hex.Encode(outBytes)));
			}
			...
			if (!AreEqual(outBytes, input))
			{
				Fail("OAEP SHA-256 test failed on decrypt expected " + Encoding.ASCII.GetString(Hex.Encode(input)) + " got " + Encoding.ASCII.GetString(Hex.Encode(outBytes)));
			}
...
//			}
			...
			{
				Fail("OAEP SHA-384 test failed on encrypt expected " + Encoding.ASCII.GetString(Hex.Encode(output[2])) + " got " + Encoding.ASCII.GetString(Hex.Encode(outBytes)));
			}
			...
			if (!AreEqual(outBytes, input))
			{
				Fail("OAEP SHA-384 test failed on decrypt expected " + Encoding.ASCII.GetString(Hex.Encode(input)) + " got " + Encoding.ASCII.GetString(Hex.Encode(outBytes)));
			}
...
//			}
			...
			{
				Fail("OAEP MD5 test failed on encrypt expected " + Encoding.ASCII.GetString(Hex.Encode(output[2])) + " got " + Encoding.ASCII.GetString(Hex.Encode(outBytes)));
			}
			...
			if (!AreEqual(outBytes, input))
			{
				Fail("OAEP MD5 test failed on decrypt expected " + Encoding.ASCII.GetString(Hex.Encode(input)) + " got " + Encoding.ASCII.GetString(Hex.Encode(outBytes)));
			}
...
//			PublicKey   isoPubKey = fact.generatePublic(isoPubKeySpec);
			...
			{
				Fail("ISO9796-1 test failed on encrypt expected " + Encoding.ASCII.GetString(Hex.Encode(output[3])) + " got " + Encoding.ASCII.GetString(Hex.Encode(outBytes)));
			}
			...
			{
				Fail("ISO9796-1 test failed on decrypt expected " + Encoding.ASCII.GetString(Hex.Encode(input)) + " got " + Encoding.ASCII.GetString(Hex.Encode(outBytes)));
			}
			...
			if (!AreEqual(outBytes, input))
			{
				Fail("key generation test failed on decrypt expected " + Encoding.ASCII.GetString(Hex.Encode(input)) + " got " + Encoding.ASCII.GetString(Hex.Encode(outBytes)));
			}
