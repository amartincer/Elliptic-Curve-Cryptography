	...
	*/
		...
		: SimpleTest
	{
		...
		public override void PerformTest()
		{
			...
			{
				Fail("failed - " + "expected " + Encoding.ASCII.GetString(Hex.Encode(output)) + " got " + Encoding.ASCII.GetString(Hex.Encode(outBytes)));
			}
			...
			{
				Fail("failed reversal got " + Encoding.ASCII.GetString(Hex.Encode(outBytes)));
			}
		}
	}
}
